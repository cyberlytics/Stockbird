...
export const callAPITweets = async (control, date_from, date_to, substrings) => {
    var myHeaders = new Headers();
    myHeaders.append('Content-Type', 'application/json');
    var raw = JSON.stringify({ control: control, date_from: date_from, date_to: date_to, substrings: substrings });
    var requestOptions = {
        method: 'POST',
        headers: myHeaders,
        body: raw,
    ...
    try {
        ...
        if (control === '_query_tweets_by_stock') {
