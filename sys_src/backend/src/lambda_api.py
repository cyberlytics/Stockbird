import atexit
import json
import sys_src.backend.src.stock.stock_data as stock_data
import sys_src.backend.src.stock.stock_analysis as stock_analysis
import sys_src.backend.src.twitter.tweet_utils as tweet_utils
import sys_src.backend.src.analysation.twitter_analysis as twitter_analysis
